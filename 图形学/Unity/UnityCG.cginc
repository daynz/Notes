...
{
    //来自http://chilliant.blogspot.com.au/2012/08/srgb-approximations-for-hlsl.html?m=1的近似版本
...
inline half3 LinearToGammaSpace (half3 linRGB)
{
    ...
    //近乎完美的近似，来自http://chilliant.blogspot.com.au/2012/08/srgb-approximations-for-hlsl.html?m=1
...
inline float3 UnityObjectToViewPos(float4 pos) // 重载函数，用于float4类型；避免现有着色器的“隐式截断”警告
{
...
// 从对象空间位置计算世界空间中的光方向
// *Legacy* 请使用 UnityWorldSpaceLightDir 代替
...
//从对象空间位置计算世界空间中的视图方向
// *Legacy* 请使用 UnityWorldSpaceViewDir 代替
